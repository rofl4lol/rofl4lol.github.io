define(["require", "exports"], function (require, exports) {
    var Utility = (function () {
        ...
        Utility.TimeSinceAgo = function (oldTime) {
        ...
        Utility.TimeSinceDuration = function (oldTime) {
        ...
        Utility.GetFriendlyDate = function (d) {
            var month = "";
            switch (d.getMonth() + 1) {
                case 1:
                    month = "Jan.";
            ...
            if (d.getMinutes() < 10)
                min = "0" + min;
            return month + " " + d.getDate() + ", " + d.getFullYear() + " " + d.getHours() + ":" + min;
        };
        return Utility;
    })();
    return Utility;
